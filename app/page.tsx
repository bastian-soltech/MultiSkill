    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <nav className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between relative z-[100]">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/register" className="bg-slate-900 text-white px-8 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-xl shadow-indigo-100">Get Started</Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 md:pt-32 pb-40 text-center relative pointer-events-auto">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl md:text-8xl font-serif italic mb-10 leading-[1.1] tracking-tight">
            Stop wandering.<br />Start <span className="text-indigo-600">Mastering.</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-500 mb-12 leading-relaxed px-4">
            Personalized roadmaps, daily accountability, and community-driven insights. 
            Craft your path to mastery with the precision of AI.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 md:mt-40 px-4">
          {[
            { icon: Compass, title: "Custom Roadmaps", text: "Generative paths tailored to your specific goals and timeline." },
            { icon: Zap, title: "Daily Check-ins", text: "Stay accountable with one-click attendance and learning logs." },
            { icon: CheckCircle2, title: "Community Adoption", text: "Adopt successful paths created by masters in the community." }
          ].map((feature, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
