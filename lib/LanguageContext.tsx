...
const translations = {
  en: {
    ...
    'ai_powered': 'Precision Skill Mastery',
    'stop_wandering': 'Stop Wandering.',
    'start_mastering': 'Manage Your Own Skills.',
    'landing_desc': 'Architect your own learning path, track daily progress, and showcase your evolving mastery. The ultimate command center for multi-talented individuals.',
    'custom_roadmaps': 'Strategic Roadmaps',
    'custom_roadmaps_desc': 'Design bespoke learning paths that map perfectly to your unique ambitions and pace.',
    'daily_checkins': 'Daily Accountability',
    'daily_checkins_desc': 'Stay consistent with one-click check-ins and detailed learning logs to secure your progress.',
    'community_adoption': 'Wisdom Sharing',
    'community_adoption_desc': 'Extract and adopt successful sequences created by fellow masters in the community.',
  ...
  id: {
    ...
    'ai_powered': 'Penguasaan Skill Presisi',
    'stop_wandering': 'Berhenti Bingung.',
    'start_mastering': 'Ayo Kelola Skill Kamu Sendiri.',
    'landing_desc': 'Rancang jalur belajarmu sendiri, lacak progres harian, dan pamerkan penguasaanmu. Pusat kendali utama untuk individu multitalenta.',
    'custom_roadmaps': 'Roadmap Strategis',
    'custom_roadmaps_desc': 'Desain jalur belajar khusus yang sesuai dengan ambisi dan kecepatan unikmu.',
    'daily_checkins': 'Akuntabilitas Harian',
    'daily_checkins_desc': 'Tetap konsisten dengan check-in satu klik dan log pembelajaran mendetail untuk mengamankan progresmu.',
    'community_adoption': 'Berbagi Kebijaksanaan',
    'community_adoption_desc': 'Ekstrak dan ambil urutan sukses yang dibuat oleh sesama master di komunitas.',
